...
<title>Tailwind Starter Template - Night Admin Template:
	Tailwind Toolbox</title>
		...
		<div
			...
			<div class="w-1/2 pl-2 md:pl-0">
				<a
					...
					href="#"> <i class="fas fa-moon text-blue-400 pr-3"></i> Admin
					Dark Mode
				</a>
			</div>
					...
					<div class="relative text-sm text-gray-100">
						<button id="userButton"
							...
							<img class="w-8 h-8 rounded-full mr-4"
								src="http://i.pravatar.cc/300" alt="Avatar of User"> <span
							...
							<ul class="list-reset">
								<li><a href="#"
									class="px-4 py-2 block text-gray-100 hover:bg-gray-800 no-underline hover:no-underline">My
										account</a></li>
								<li><a href="#"
									class="px-4 py-2 block text-gray-100 hover:bg-gray-800 no-underline hover:no-underline">Notifications</a></li>
								<li><hr class="border-t mx-2 border-gray-400"></li>
								<li><a href="#"
									class="px-4 py-2 block text-gray-100 hover:bg-gray-800 no-underline hover:no-underline">Logout</a></li>
							</ul>
						</div>
					</div>
			...
			<div
				...
				<ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
					<li class="mr-6 my-2 md:my-0"><a href="./"
						...
						<div class="flex flex-row items-center">
							...
							<div class="flex-1 text-right md:text-center">
								...
								<h3 class="font-bold text-3xl text-gray-600">
									$3249 <span class="text-green-500"><i
					...
					<div class="bg-gray-900 border border-gray-800 rounded shadow p-2">
						<div class="flex flex-row items-center">
							...
							<div class="flex-1 text-right md:text-center">
								...
								<h3 class="font-bold text-3xl text-gray-600">
									249 <span class="text-pink-500"><i
					...
					<div class="bg-gray-900 border border-gray-800 rounded shadow p-2">
						<div class="flex flex-row items-center">
							...
							<div class="flex-1 text-right md:text-center">
								...
								<h3 class="font-bold text-3xl text-gray-600">
									2 <span class="text-yellow-600"><i
										class="fas fa-caret-up"></i></span>
								</h3>
							</div>
						</div>
			...
			<div class="w-full mx-auto flex flex-wrap">
				<div class="flex w-full md:w-1/2 ">
					<div class="px-8">
						...
						<p class="py-4 text-gray-600 text-sm">Lorem ipsum dolor sit
							amet, consectetur adipiscing elit. Maecenas vel mi ut felis
							tempus commodo nec id erat. Suspendisse consectetur dapibus velit
							ut lacinia.</p>
					</div>
				</div>
